...
const ProductAdminPage:FC<Props> = ({ product }) => {
    ...
    const [isSaving, setIsSaving] = useState(false); //para Evitar el doble posteo
    ...
    useEffect(() => {
        // Este watch genera un observable, cuando se sale de la página aún sigue escuchando, por eso hay que limpiarlo en la función de retorno del useEffect
        // Para no tener eventos duplicados escuchando lo mismo.
      ...
      return () => {
        subscription.unsubscribe() //destruimos
      }
    }, [watch, setValue])
            ...
            <form onSubmit={ handleSubmit( onSubmit ) }>
                <Box display='flex' justifyContent='end' sx={{ mb: 1 }}>
                    <Button 
                        ...
                        sx={{ width: '150px' }}
                        type="submit"
                        disabled= { isSaving } //Evitar el doble posteo
                        >
                        Guardar
                    </Button>
                </Box>
