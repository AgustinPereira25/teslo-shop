...
const navigateTo = ( url: string ) => {
  ...
  return (
    <Drawer
        open= { isMenuOpen } //Context.
        onClose = { toggleSideMenu }
        anchor='right' // Posición en la que quiero que aparezca
        sx={{ backdropFilter: 'blur(4px)', transition: 'all 0.5s ease-out' }} //backdropFilter= blur en el fondo
    >
        <Box sx={{ width: 250, paddingTop: 5 }}>
            ...
            <List>
                ...
                <ListItem 
                    button
                    sx={ isLoggedIn ? { display: 'none'} : {display: 'flex'}}
                ...
                <ListItem 
                    button
                    sx={ isLoggedIn ? { display: 'flex'} : {display: 'none'}}
                    onClick = { logout }
                >
                    <ListItemIcon>
                        <LoginOutlined/>
